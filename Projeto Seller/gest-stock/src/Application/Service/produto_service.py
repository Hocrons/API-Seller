...
class ProdutoService:
    ...
    def create_produto(nome, preco, quantidade_estoque, status, imagem, seller_id):
        try:
            ValidadorProduto.validar_campos_criar(nome, preco, quantidade_estoque)
    ...
    @staticmethod
    def update_produto(produto_id, seller_id, nome=None, preco=None, quantidade_estoque=None, status=None, imagem=None):
        produto = Produto.query.filter_by(id=produto_id, seller_id=seller_id).first()
        if not produto:
